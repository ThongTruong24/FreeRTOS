...
C_SRCS += \
../BSP/hal_callbacks/hal_callbacks.c 

OBJS += \
./BSP/hal_callbacks/hal_callbacks.o 

C_DEPS += \
./BSP/hal_callbacks/hal_callbacks.d 


# Each subdirectory must supply rules for building sources it contributes
BSP/hal_callbacks/%.o BSP/hal_callbacks/%.su BSP/hal_callbacks/%.cyclo: ../BSP/hal_callbacks/%.c BSP/hal_callbacks/subdir.mk
...
clean: clean-BSP-2f-hal_callbacks

clean-BSP-2f-hal_callbacks:
	-$(RM) ./BSP/hal_callbacks/hal_callbacks.cyclo ./BSP/hal_callbacks/hal_callbacks.d ./BSP/hal_callbacks/hal_callbacks.o ./BSP/hal_callbacks/hal_callbacks.su

.PHONY: clean-BSP-2f-hal_callbacks
