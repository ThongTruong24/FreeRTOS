...
C_SRCS += \
../BSP/slave_link_port/slave_link_port.c 

OBJS += \
./BSP/slave_link_port/slave_link_port.o 

C_DEPS += \
./BSP/slave_link_port/slave_link_port.d 


# Each subdirectory must supply rules for building sources it contributes
BSP/slave_link_port/%.o BSP/slave_link_port/%.su BSP/slave_link_port/%.cyclo: ../BSP/slave_link_port/%.c BSP/slave_link_port/subdir.mk
...
clean: clean-BSP-2f-slave_link_port

clean-BSP-2f-slave_link_port:
	-$(RM) ./BSP/slave_link_port/slave_link_port.cyclo ./BSP/slave_link_port/slave_link_port.d ./BSP/slave_link_port/slave_link_port.o ./BSP/slave_link_port/slave_link_port.su

.PHONY: clean-BSP-2f-slave_link_port
