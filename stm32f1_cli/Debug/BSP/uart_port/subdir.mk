...
C_SRCS += \
../BSP/uart_port/uart_port.c 

OBJS += \
./BSP/uart_port/uart_port.o 

C_DEPS += \
./BSP/uart_port/uart_port.d 


# Each subdirectory must supply rules for building sources it contributes
BSP/uart_port/%.o BSP/uart_port/%.su BSP/uart_port/%.cyclo: ../BSP/uart_port/%.c BSP/uart_port/subdir.mk
...
clean: clean-BSP-2f-uart_port

clean-BSP-2f-uart_port:
	-$(RM) ./BSP/uart_port/uart_port.cyclo ./BSP/uart_port/uart_port.d ./BSP/uart_port/uart_port.o ./BSP/uart_port/uart_port.su

.PHONY: clean-BSP-2f-uart_port
