...
C_SRCS += \
../Application/param/param.c 

OBJS += \
./Application/param/param.o 

C_DEPS += \
./Application/param/param.d 


# Each subdirectory must supply rules for building sources it contributes
Application/param/%.o Application/param/%.su Application/param/%.cyclo: ../Application/param/%.c Application/param/subdir.mk
...
clean: clean-Application-2f-param

clean-Application-2f-param:
	-$(RM) ./Application/param/param.cyclo ./Application/param/param.d ./Application/param/param.o ./Application/param/param.su

.PHONY: clean-Application-2f-param
